...
The effectiveness of CMNMF on gene modules clustering is demonstrated on sampled gene-phenotype association matrices at first by comparing the difference of conventional NMF, ColNMF and proposed CMNMF. We then execute CMNMF and four baseline methods on MGI mouse gene-phenotype ontology association data for mining mouse gene functional modules. Moreover, the evaluation of clustering results and parameter tuning are performed. Finally, gene ontology enrichment analysis is conducted to evaluate the biological significance of mined gene modules.
