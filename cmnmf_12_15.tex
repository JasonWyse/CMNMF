...
after removing phenotypes, which neither has relationships with any disease genes in gene-phenotype associations nor has relationships with any phenotypes in any levels in hierarchial mapping relations, then we generate a dataset containing 1354 disease genes and 5245 phenotypes.
...
\hline
&$F_1$ measure &Jaccard Index& Rand Index&$GO_{rate}$&$\mathcal{I}_1$\\
\hline
...
%\hline
CMNMF(0.5)&\textbf{0.1065}& \textbf{0.0563}&{0.9701}& \textbf{0.6078}&16.0158\\
